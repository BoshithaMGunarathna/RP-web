...
// Use public folder path directly for images
const boshi = '/img/boshi1.JPG';
const deneth = '/img/deneth.jpg';
const shehela = '/img/shehela.jpeg';
const indu = '/img/indu.jpeg';
const dilshan = '/img/dilshani.jpg';
const poojani = '/img/poojani.jpeg';
                ...
                <div className="relative w-full aspect-square overflow-hidden bg-gray-100">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.src = 'https://images.pexels.com/photos/5384445/pexels-photo-5384445.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&dpr=1';
                    }}
                  />
                </div>
                <div className="p-6">
