...
const Documents = () => {
  ...
  const documents: Document[] = [
    ...
    {
      id: '11',
      title: 'Voice Data Set - IT21319792 Gunarathna N.W.P.B.M.',
      description: 'Comprehensive voice data collection and analysis dataset contributed by Gunarathna N.W.P.B.M. for the confidence level evaluation.',
      category: 'data',
      date: 'Aug 02, 2024',
    ...
    {
      id: '12',
      title: 'Code Complexity Data Set - IT21167232 Anjalie P.M.R.S.',
      description: 'Comprehensive code complexity data collection and analysis dataset contributed by Anjalie P.M.R.S. for the technical interview evaluation.',
      category: 'data',
      date: 'Aug 02, 2024',
      fileType: 'Collected Dataset',
      fileSize: 'Online',
      filePath: 'https://docs.google.com/spreadsheets/d/1GcdkKzPTF0-N9ItJx2t2IWXl7fWwbitD/edit?usp=sharing&ouid=112061250690827233343&rtpof=true&sd=true',
    },
    {
      id: '13',
      title: 'Image Dataset - IT21167232 Thennakoon T.M.I.C.',
      description: 'Comprehensive image data collection and analysis dataset contributed by Thennakoon T.M.I.C. for the stress level evaluation.',
      category: 'data',
      date: 'Aug 02, 2024',
      fileType: 'Kaggle Dataset',
      fileSize: 'Online',
    ...
    {
      id: '14',
      title: 'Image Dataset - IT21158186 Pinsara A.R.D.',
      description: 'Comprehensive image data collection and analysis dataset contributed by Pinsara A.R.D. for Candidate Pre-Evaluation with video based mockup test.',
      category: 'data',
      date: 'Aug 02, 2024',
      fileType: 'Customized Dataset',
      fileSize: 'Online',
      filePath: 'https://drive.google.com/drive/folders/1C12yES3qnpJ14qAF9pWupI2yzboKleT1?usp=sharing',
    },
  ];
